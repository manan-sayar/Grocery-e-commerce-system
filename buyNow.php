            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="#"><strong>Call: </strong>+91-8888888888</a></li>
                            <li><a href="#"><strong>Mail: </strong>kjsomaiya@gmail.com</a></li>
                            <li class="divider"></li>
...
<tfoot>
          <tr>
            <td colspan="4" align="center">TOTAL AMOUNT <?php echo "  $total"; ?></td>
		</tr>
		<tr>
			<td colspan="4" align="center">
			<form method="GET" action="confirmOrder.php" cellpadding="20">
				<p><input type="submit"  value="CONFIRM ORDER" class="btn btn-success" role="button"></p>
		...
		<!--
            ...
            <div class="col-md-4">
                ...
                <p>
                     K.J. Somaiya College of Engineering<br />
									Vidyavihar,INDIA<br/>
                    Call:+91-8888888888<br>
                    Email:kjsomaiya@gmail.com<br>
                </p>
